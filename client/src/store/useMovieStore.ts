...
const useMovieStore = create<MovieStore>((set, get) => ({
  ...
  fetchAllContent: async (page = 1, limit = 20) => {
    try {
      set({ loading: true });
      const response = await axios.get(API_ROUTES.CONTENT.ALL, {
        params: { page, limit },
      });
      set({ content: response.data.data });
    } catch (error) {
      set({ error: "Failed to fetch content" });
    } finally {
      set({ loading: false });
    }
  },
  ...
  fetchContentById: async (id: string) => {
    try {
      set({ loading: true });
      const response = await axios.get(API_ROUTES.CONTENT.BY_ID(id));
  ...
  fetchFeaturedContent: async () => {
    try {
      set({ loading: true });
      const response = await axios.get(API_ROUTES.CONTENT.FEATURED);
  ...
  fetchTrendingContent: async () => {
    try {
      set({ loading: true });
      const response = await axios.get(API_ROUTES.CONTENT.TRENDING);
  ...
  fetchNewReleases: async () => {
    try {
      set({ loading: true });
      const response = await axios.get(API_ROUTES.CONTENT.NEW_RELEASES);
  ...
  fetchContentByGenre: async (genreId: string) => {
    try {
      set({ loading: true });
      const response = await axios.get(API_ROUTES.CONTENT.BY_GENRE(genreId));
      set(state => ({ 
        contentByGenre: { 
  ...
  searchContent: async (query: string) => {
    try {
      set({ loading: true });
      const response = await axios.get(API_ROUTES.CONTENT.SEARCH, {
        params: { query },
      });
  ...
  rateContent: async (contentId: string, score: number) => {
    try {
      set({ loading: true });
      await axios.post(API_ROUTES.CONTENT.RATE(contentId), { score });
  ...
  addReview: async (contentId: string, review: Review) => {
    try {
      set({ loading: true });
      await axios.post(API_ROUTES.CONTENT.REVIEW(contentId), review);
      await get().fetchContentById(contentId);
    } catch (error) {
  ...
  toggleLike: async (contentId: string) => {
    try {
      set({ loading: true });
      await axios.post(API_ROUTES.CONTENT.LIKE(contentId));
      await get().fetchContentById(contentId);
    } catch (error) {
  ...
  toggleWatchlist: async (contentId: string) => {
    try {
      set({ loading: true });
      await axios.post(API_ROUTES.USER.WATCHLIST.TOGGLE(contentId));
    } catch (error) {
  ...
  getWatchlist: async () => {
    try {
      set({ loading: true });
      const response = await axios.get(API_ROUTES.USER.WATCHLIST.GET);
  ...
  fetchContinueWatching: async () => {
    try {
      set({ loading: true });
      const response = await axios.get(API_ROUTES.USER.CONTINUE_WATCHING);
  ...
  fetchRecommendations: async () => {
    try {
      set({ loading: true });
      const response = await axios.get(API_ROUTES.USER.RECOMMENDATIONS);
  ...
  fetchTVShowSeasons: async (showId: string) => {
    try {
      set({ loading: true });
      const response = await axios.get(API_ROUTES.TV_SHOW.SEASONS(showId));
  ...
  deleteContent: async (id: string) => {
    try {
      set({ loading: true });
      await axios.delete(API_ROUTES.ADMIN.CONTENT.DELETE(id));
  ...
  fetchGenres: async () => {
    try {
      set({ loading: true });
      const response = await axios.get(API_ROUTES.GENRE.ALL);
